    ...
    <div className="min-h-[700px] pt-[100px]">
      <ContentWrapper>
        <div className="flex justify-between mb-[25px] flex-col md:flex-row">
          <div
            className="text-[24px] leading-[34px] text-[#FFD700] mb-[20px]
          md:mb-0"
          >
          ...
          <div className="flex gap-[10px] flex-col md:flex-row">
            <Select
              ...
              className="react-select-container genresDD md:max-w-[500px] md:min-w-[250px]"
        ...
        {!loading && (
          <>
            {data?.results?.length > 0 ? (
              <InfiniteScroll
                className="contentent md:gap-[20px]"
              ...
              <span className="font-chirp font-semibold text-[#7393B3] text-[24px]">
